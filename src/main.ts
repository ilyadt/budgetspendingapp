...
import { faSync, faCheck, faXmark, faHome, faReceipt, faFloppyDisk } from '@fortawesome/free-solid-svg-icons'
...
library.add(faSync, faCheck, faXmark, faHome, faReceipt, faFloppyDisk, faGripDotsVertical)
